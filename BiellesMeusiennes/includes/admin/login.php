...
//Cette fonction doit Ítre appelÈe avant tout code html
generer_token();
...
if (!isset($_POST['username'])) //On est dans la page de formulaire
{
	...
	if (isset($_GET['message'])) {
		if ($_GET['message'] == "errorlogin") {
			echo '<div><p>Une erreur s\'est produite pendant votre identification.<br /> Le mot de passe ou l\'identifiant entr√© n\'est pas correct.</p></div>';
		}
